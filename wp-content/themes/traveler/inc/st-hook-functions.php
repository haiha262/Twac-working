...
//        ) ) );
    ...
    if ( !function_exists( 'st_add_scripts' ) ) {
        function st_add_scripts()
        {
            ...
            /**
             * @since 2.0.0
             * Bulk calendar start time
             */
            wp_register_script( 'bulk-starttime-calendar', get_template_directory_uri() . '/js/init/bulk-starttime-calendar.js', [ 'jquery', ], null, true );
...
//            wp_enqueue_script( 'custom.js', get_template_directory_uri() . '/js/custom.js', [ 'jquery' ], null, true );
            ...
            if ( is_page_template( 'template-user.php' ) ) {
                ...
                if ( get_query_var( 'sc' ) == 'edit-tours' ) {
                    ...
                    //Add tour starttime partner js
                    wp_enqueue_script( 'tour_starttime_availability_partner', get_template_directory_uri() . '/js/availability_tour_starttime_partner.js', [ 'jquery' ], NULL, TRUE );
                }
