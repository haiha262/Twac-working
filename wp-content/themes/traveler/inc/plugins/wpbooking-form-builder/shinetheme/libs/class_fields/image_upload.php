...
if(!class_exists('WB_Form_Builder_Image_Upload')){
    class WB_Form_Builder_Image_Upload extends WB_Form_Builder_Abstract_fields{
        ...
        function get_admin_html($data, $order_id){
            ...
            $html = '<div class="form-row wb-upload-fields">
                        ...
                        <div class="controls">
                            ...
                            <div class="wb-load-image">'.wp_get_attachment_image($value, $size_image, false, array('class' => 'frontend-image img-responsive')).'<a class="delete" href="javascript:void(0);">&times;</a></div>
                        </div>
                    </div>';
            return $html;
        }
