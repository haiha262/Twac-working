    ...
    if ( !class_exists( 'STAdminTours' ) ) {
        ...
        class STAdminTours extends STAdmin
        {
            ...
            function __construct()
            {
                ...
                /**
                 * @since 2.0.0
                 * Bulk Start Time calendar
                 */
                add_action( 'traveler_after_form_tour_starttime_calendar', [ $this, 'custom_traveler_after_form_tour_starttime_calendar' ] );
                add_action( 'traveler_after_form_submit_tour_starttime_calendar', [ $this, 'custom_traveler_after_form_submit_tour_starttime_calendar' ] );
            }
             ...
             * Bulk Start Time Calendar
             */
            public function custom_traveler_after_form_tour_starttime_calendar()
            {
                echo balanceTags( st()->load_template( 'tours/tour-starttime-calendar', false ) );
            }

            public function custom_traveler_after_form_submit_tour_starttime_calendar()
            {
                echo '<button type="button" id="calendar-starttime-bulk-edit" class="option-tree-ui-button option-tree-ui-button traveler_after_form_submit_tour_calendar button button-primary button-large btn btn-primary btn-sm" style="float: right;">' . __( 'Bulk Edit', ST_TEXTDOMAIN ) . '</button>';
            }
            //End Bulk Start Time
            ...
            function init_metabox()
            {
                ...
                $this->metabox[] = [
                    ...
                    'fields'   => [
                        ...
                        /**
                         * @update 2.0.0
                         * Add startt time for tour
                         */
                        [
                            'label' => __( 'Start Time', ST_TEXTDOMAIN ),
                            'id'    => 'starttime_tab',
                            'type'  => 'tab'
                        ],

                        [
                            'label' => __( 'Start Time Calendar', ST_TEXTDOMAIN ),
                            'id'    => 'st_starttime_tour_calendar',
                            'type'  => 'st_tour_starttime_calendar'
                        ],
                        /**
                         * Tour package(Hotel)
                         */
