    ...
    function st_email_booking_item_link(){
        ...
        if($order_id){
            ...
            if($item_id == 'car_transfer'){
                ...
                return '<a style="text-decoration: unset; color: #666;" href="'.get_the_permalink($item_id).'" title="">'.get_the_title($item_id).'</a><br/>
...
if( !function_exists('st_email_partner_package_number_expired') ){
    function st_email_partner_package_number_expired(){
        ...
        if ($time == 'unlimited') {
            ...
            $countdown_string = $date_diff . esc_html(' day(s)', ST_TEXTDOMAIN);
        }
