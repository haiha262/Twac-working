        ...
        static function getPeoplePrice($tour_id, $check_in, $check_out){
            ...
            $sql = "
				...
				AND (
				  ...
				  post_type = 'st_tours' OR post_type = 'st_activity'
				)";
            //Select price for adult, children...
            ...
            if(is_array($cart) && count($cart)){
                foreach($cart as $key => $val){
                    ...
                    if(get_post_type($post_id) == 'st_tours'){
                        ...
                        $price_with_tax = self::getPriceWithTax($sale_price + $extra_price + $hotel_package_price + $activity_package_price + $car_package_price);
                        $price_with_tax -= $coupon_price;
