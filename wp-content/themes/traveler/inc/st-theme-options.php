...
$custom_settings = array(
    ...
    ,
        ...
        array(
            'id' => 'cba_enable',
            'label' => esc_html__('Turn on Colibri API', ST_TEXTDOMAIN),
            'type' => 'on-off',
            'section' => 'option_api_update',
            'std' => 'off'
        ),
        ...
        array(
            'id' => 'cba_page_detail_room',
            'label' => __('Detail hotel room page', ST_TEXTDOMAIN),
            'desc' => __('Select the page to display detail hotel room', ST_TEXTDOMAIN),
            'type' => 'page-select',
            'section' => 'option_api_update',
            'condition' => 'cba_enable:is(on)'
        ),
        array(
            ...
            'desc' => __('Select checkoutpage to display detail hotel', ST_TEXTDOMAIN),
            'type' => 'page-select',
            'section' => 'option_api_update',
            'condition' => 'cba_enable:is(on)'
        ),
        ...
        array(
            ...
            'label' => __('View checkout page', ST_TEXTDOMAIN),
            'desc' => __('Turn on/off checkout page of room', ST_TEXTDOMAIN),
            'type' => 'on-off',
            'section' => 'option_api_update',
            'std' => 'off',
            'condition' => 'cba_enable:is(on)'
