<?php 
    ...
    $current_calendar_date = TravelHelper::get_current_available_calendar(get_the_ID());
    //echo $current_calendar_date;
?>
<div class="row calendar-wrapper" data-post-id="<?php echo get_the_ID(); ?>" data-current-date="<?php echo $current_calendar_date; ?>">
    <div class="col-xs-12 calendar-wrapper-inner">
        ...
        <div class="calendar-content"
             ...
             data-date-start="<?php echo AvailabilityHelper::_get_availability_date_srart(get_the_ID()); ?>"
            >
        </div>
    </div>
