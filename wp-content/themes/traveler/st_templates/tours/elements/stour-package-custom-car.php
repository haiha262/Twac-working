...
<div class="custom-hotel-data-item">
    <table class="wp-list-table widefat fixed striped stour-list-custom-hotel" data-type="car">
        ...
        <tr>
            ...
            <td><?php echo __('Car price', ST_TEXTDOMAIN); ?></td>
            <td><?php echo __('Car Quantity', ST_TEXTDOMAIN); ?></td>
        </tr>
        </thead>
        <tbody>
        <tr class="parent-row">
            ...
            <td><input type="text" class="car-name" value=""/></td>
            <td><input type="text" class="car-price" value=""/></td>
            <td><input type="number" class="car-quantity" value=""/></td>
        </tr>
        <?php
            ...
            if (!empty((array)$tour_package_custom)) {
                foreach ($tour_package_custom as $k => $v) {
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="car-name" value="<?php echo $v->car_name; ?>"/></td>
                        <td><input type="text" class="car-price" value="<?php echo $v->car_price; ?>"/></td>
                        <td><input type="number" class="car-quantity" value="<?php echo $v->car_quantity; ?>"/></td>
                    </tr>
                    <?php
                }
            }
