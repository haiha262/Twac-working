...
<div class="custom-hotel-data-item">
    <table class="wp-list-table widefat fixed striped stour-list-custom-hotel" data-type="activity">
        ...
        <tr>
            ...
            <td><?php echo __('Activity price', ST_TEXTDOMAIN); ?></td>
        </tr>
        </thead>
        <tbody>
        <tr class="parent-row">
            ...
            <td><input type="text" class="activity-name" value=""/></td>
            <td><input type="text" class="activity-price" value=""/></td>
        </tr>
        <?php
            ...
            if (!empty((array)$tour_package_custom)) {
                foreach ($tour_package_custom as $k => $v) {
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="activity-name" value="<?php echo $v->activity_name; ?>"/></td>
                        <td><input type="text" class="activity-price" value="<?php echo $v->activity_price; ?>"/></td>
                    </tr>
                    <?php
                }
            }
