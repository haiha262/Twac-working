...
<div class="custom-hotel-data-item">
    <table class="wp-list-table widefat fixed striped stour-list-custom-hotel" data-type="hotel">
        ...
        <tr>
            ...
            <td><?php echo __('Hotel tar', ST_TEXTDOMAIN); ?></td>
        ...
        <tr class="parent-row">
            ...
            <td><input type="text" class="hotel-name" value=""/></td>
            <td><input type="number" min="0" max="5" step="0.5" class="hotel-star" value=""/></td>
            <td><input type="text" class="hotel-price" value=""/></td>
        </tr>
        <?php
            ...
            if (!empty((array)$tour_package_custom)) {
                foreach ($tour_package_custom as $k => $v) {
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="hotel-name" value="<?php echo $v->hotel_name; ?>"/></td>
                        <td><input type="number" min="0" max="5" step="0.5" class="hotel-star"
                                   value="<?php echo $v->hotel_star; ?>"/></td>
                        <td><input type="text" class="hotel-price" value="<?php echo $v->hotel_price; ?>"/></td>
                    </tr>
                    <?php
                }
            }
