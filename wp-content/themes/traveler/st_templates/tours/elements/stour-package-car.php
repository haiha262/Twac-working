    ...
    <table class="wp-list-table widefat fixed striped stour-list-hotel" data-type="car">
        ...
        <?php foreach ($ids as $k => $v) { ?>
            <tr>
                ...
                <td><input type="text" class="hotel-price" value="<?php echo (!empty($arr_tour_package) && isset($arr_tour_package[$v['ID']]) ) ? $arr_tour_package[$v['ID']]->car_price : ''; ?>"/></td>
                <td><input type="number" min="0" class="hotel-price" value="<?php echo (!empty($arr_tour_package) && isset($arr_tour_package[$v['ID']]) ) ? $arr_tour_package[$v['ID']]->car_quantity : ''; ?>"/></td>
            </tr>
        <?php } ?>
        </tbody>
    </table>
