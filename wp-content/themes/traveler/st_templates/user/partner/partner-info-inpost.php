        ...
        <div class="partner-ipost-content">
            <div class="row">
                <div class="col-lg-<?php echo $number_column; ?>">
                    <div class="author-info-meta <?php echo $avatar_type == 'square' ? 'avatar-square' : 'avatar-circle' ?>">
                ...
                <div class="col-lg-<?php echo $number_column; ?>">
                    ...
                    <ul class="author-list-info">
                        <?php if (isset($user_meta['st_is_check_show_info']) && $user_meta['st_is_check_show_info'] == 'on' && (in_array('all', $list_info) || in_array('email', $list_info))) : ?>
                            <li>
