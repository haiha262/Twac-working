...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner">
    ...
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="st_title" type="text" placeholder="<?php echo __('Name of tour', ST_TEXTDOMAIN); ?>"
    ...
    <div class="tabbable tabs_partner">
        <ul class="nav nav-tabs" id="">
            ...
            <?php } ?>
            <!--Add tab heading starttime partner -->
            <?php if (!empty($post_id)) { ?>
                <li><a href="#starttime_tab" data-toggle="tab"><?php _e("Start Time", ST_TEXTDOMAIN) ?></a></li>
            <?php } ?>
            <li><a href="#package_tab" data-toggle="tab"><?php _e("Tour Packages", ST_TEXTDOMAIN) ?></a></li>
            <?php if (!empty($post_id)) { ?>
        ...
        <div class="tab-content">
                    ...
                    <div class='col-md-6'>
                        <div class="form-group">
                            <label for="min_people"><?php _e("Min people", ST_TEXTDOMAIN) ?> <span
                                        class="text-small text-danger">*</span>:</label>
                            <input id="min_people" name="min_people" type="text" min="1"
            ...
            <!-- Add Tab Panel Starttime partner -->
            <?php if (!empty($post_id)) { ?>
                <div class="tab-pane fade" id="starttime_tab">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-icon-left">
                                <label for="starttime"><?php _e("Start Time", ST_TEXTDOMAIN) ?>:</label>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <?php echo st()->load_template('availability/form-starttime-tour'); ?>
                        </div>
                    </div>
                </div>
            <?php } ?>
            ...
            <!-- End Ical -->
            <!-- Tour Package -->
            <div class="tab-pane fade" id="package_tab">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-icon-left">
